...
<head>
    ...
    <title>CPSU Payroll | Log in</title>
                ...
                <div class="row">
                    <div class="col-md-7">
                        <p style="font-size: 19pt; font-family: 'Oxygen',sans-serif;" class="card-body">
                            Central Philippines State University Payroll Management System
                        </p>
                    ...
                    <div class="col-md-5 pr-4 pl-4 pt-2 pb-2" style="background-color: #d7d7d7; border-radius: 5px;">
